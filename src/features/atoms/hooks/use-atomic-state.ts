...
export const useAtomicValue = <T>(atom: AtomState<T>): T | undefined => {
...
export const useAtomicState = <T>(atom: WritableAtomState<T>): [value: T | undefined, set: (value: ValueOrSetter<T>) => void] => {
