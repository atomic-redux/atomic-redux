...
Internally, it automatically builds a [directed acyclic graph](https://en.wikipedia.org/wiki/Directed_acyclic_graph) of dependencies, to prevent unneccesary re-execution of selectors, without requiring manual memoisation like Redux selectors do.
